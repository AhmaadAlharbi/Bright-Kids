...
<head>
    ...
    <title>Home Three || Kidearn || HTML Template For Kindergarten & Baby Care</title>
    <!-- favicons Icons -->
...
<body class="custom-cursor">
    ...
    <div class="page-wrapper">
                ...
                <div class="main-header__inner">
                    ...
                    <nav class="main-header__nav main-menu">
                        <ul class="main-menu__list one-page-scroll-menu">
                            ...
                            <li class="scrollToLink"><a href="#service">Services</a></li>
                            <li class="scrollToLink"><a href="#about">About</a></li>
                            <li class="scrollToLink"><a href="#program">Program</a></li>
                            <li class="scrollToLink"><a href="#team">Team</a></li>
                            <li class="scrollToLink"><a href="#event">Event</a></li>
        ...
        <section class="service-three" id="service">
            <div class="container">
                    ...
                    <div class="col-xl-6 wow fadeInRight" data-wow-delay="200ms">
                        <div class="about-three__content">
                            ...
                            <div class="about-three__info-wrapper">
                                ...
                                <a class="about-three__call" href="tel:303555-0105">
                                    ...
                                    <span class="about-three__call__content">
                                        <span class="about-three__call__number">(303) 555-0105</span>
        ...
        <section class="program-three" id="program">
                    ...
                    <div class="col-xl-3 col-md-6">
                        <div class="program-three__item wow fadeInUp" data-wow-duration='1500ms' data-wow-delay='00ms'
                            ...
                            <div class="program-three__item__content">
                                ...
                                <h3 class="program-three__item__title"><a href="programs-d-toddler.html">Toddler</a>
                                </h3><!-- /.program-three__item__title -->
                                <div class="program-three__item__age">(1.5-3 years)</div>
                                <!-- /.program-three__item__age -->
                                <p class="program-three__item__text">Lorem Ipsum is simply dummy text of the printing
                    ...
                    <div class="col-xl-3 col-md-6">
                        <div class="program-three__item wow fadeInUp" data-wow-duration='1500ms' data-wow-delay='100ms'
                            ...
                            <div class="program-three__item__content">
                                ...
                                <h3 class="program-three__item__title"><a href="programs-d-preschool.html">Preschool</a>
                                </h3><!-- /.program-three__item__title -->
                    ...
                    <div class="col-xl-3 col-md-6">
                        <div class="program-three__item wow fadeInUp" data-wow-duration='1500ms' data-wow-delay='200ms'
                            ...
                            <div class="program-three__item__content">
                                ...
                                <h3 class="program-three__item__title"><a
                    ...
                    <div class="col-xl-3 col-md-6">
                        <div class="program-three__item wow fadeInUp" data-wow-duration='1500ms' data-wow-delay='300ms'
                            ...
                            <div class="program-three__item__content">
                                ...
                                <h3 class="program-three__item__title"><a href="programs-d-flex-care.html">Flex-care</a>
                                </h3><!-- /.program-three__item__title -->
				...
				"992": {
                    ...
                    <div class="item">
                        <div class="team-card-three wow fadeInUp" data-wow-duration='1500ms' data-wow-delay='00ms'
                            ...
                            <div class="team-card-three__normal">
                                <h3 class="team-card-three__normal__title">Jane cooper</h3>
                                <!-- /.team-card-three__title -->
                                <p class="team-card-three__normal__designation">Swimming Teacher</p>
                            ...
                            <div class="team-card-three__hover">
                                ...
                                <p class="team-card-three__designation">Swimming Teacher</p>
                                <!-- /.team-card-three__designation -->
                                ...
                                <a class="team-card-three__rm" href="team-details.html"><span
                    ...
                    <div class="item">
                        <div class="team-card-three wow fadeInUp" data-wow-duration='1500ms' data-wow-delay='100ms'
                            ...
                            <div class="team-card-three__normal">
                                <h3 class="team-card-three__normal__title">Cody fisher</h3>
                                <!-- /.team-card-three__title -->
                                <p class="team-card-three__normal__designation">Art Teacher</p>
                                <!-- /.team-card-three__designation -->
                                <div class="team-card-three__normal__social">
                                    <a class="fb" href="https://facebook.com">
                                        <span class="social-bg">
                            ...
                            <div class="team-card-three__hover">
                                ...
                                <p class="team-card-three__designation">Art Teacher</p>
                                <!-- /.team-card-three__designation -->
                                <div class="team-card-three__social">
                                    <a class="fb" href="https://facebook.com">
                                        <span class="social-bg">
                    ...
                    <div class="item">
                        <div class="team-card-three wow fadeInUp" data-wow-duration='1500ms' data-wow-delay='200ms'
                            ...
                            <div class="team-card-three__normal">
                                <h3 class="team-card-three__normal__title">Floyd miles</h3>
                                <!-- /.team-card-three__title -->
                                <p class="team-card-three__normal__designation">Sports Teacher</p>
                                <!-- /.team-card-three__designation -->
                                <div class="team-card-three__normal__social">
                                    <a class="fb" href="https://facebook.com">
                                        <span class="social-bg">
                            ...
                            <div class="team-card-three__hover">
                                ...
                                <p class="team-card-three__designation">Sports Teacher</p>
                                <!-- /.team-card-three__designation -->
                                <div class="team-card-three__social">
                                    <a class="fb" href="https://facebook.com">
                                        <span class="social-bg">
                            ...
                            <div class="testimonial-three__item">
                                ...
                                <div class="testimonial-three__item__wrapper">
                                    <div class="testimonial-three__item__author">
                                        ...
                                        <h5 class="testimonial-three__item__author__name">Savannah Nguyen</h5>
                                        <p class="testimonial-three__item__author__designation">Martin’s Father</p>
                                    </div>
                            ...
                            <div class="testimonial-three__item">
                                ...
                                <div class="testimonial-three__item__wrapper">
                                    <div class="testimonial-three__item__author">
                                        ...
                                        <h5 class="testimonial-three__item__author__name">Sarah Taylor</h5>
                                        <p class="testimonial-three__item__author__designation">Martin’s Mother</p>
                                    </div>
                                    <div class="testimonial-three__item__ratings">
                                        <span class="fa fa-star"></span><span class="fa fa-star"></span><span
                                            class="fa fa-star"></span><span class="fa fa-star"></span><span
        ...
        <section class="event-one" id="event">
            <div class="container">
                <div class="sec-title text-center">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-7 d-flex align-items-center">
                                    <div class="event-card__content">
                                        <div class="event-card__cats"><a href="events-grid.html">Kindergarten</a></div>
                                        <!-- /.event-card__cats -->
                                        <ul class="event-card__lists">
                                            <li><span class="icon-clock1"></span>08:00am - 05:00pm</li>
                                            <li><span class="icon-location-fill"></span>6391 Elgin St. Celina, Delaware
                                                10299</li>
                                        </ul><!-- /.event-card__lists -->
                                        <h3 class="event-card__title"><a href="events-details.html">The complete web
                                                developer guideline 2023</a></h3><!-- /.event-card__title -->
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-7 d-flex align-items-center">
                                    <div class="event-card__content">
                                        ...
                                        <h3 class="event-card__title"><a href="events-details.html">Let’s spend summer
                                                together with your teachers</a></h3><!-- /.event-card__title -->
                                    </div><!-- /.event-card__content -->
                                </div>
                            </div>
                        </div><!-- /.event-card -->
        ...
        <section class="blog-one blog-one--home-three" id="blog">
                        ...
                        <div class="blog-card wow fadeInUp" data-wow-duration='1500ms' data-wow-delay='000ms'>
                            ...
                            <div class="blog-card__content">
                                <div class="blog-card__content__top">
                                    <a href="blog-list.html" class="blog-card__category">Kindergarten</a>
                                    <div class="blog-card__date">30 Mar, 2023</div><!-- /.blog-card__date -->
                                </div><!-- /.blog-card__content__top -->
                                <h3 class="blog-card__title"><a href="blog-details-right.html">10 Easy steps to more
                                        learn about play</a></h3><!-- /.blog-card__title -->
                        ...
                        <div class="blog-card wow fadeInUp" data-wow-duration='1500ms' data-wow-delay='100ms'
                            ...
                            <div class="blog-card__image">
                                ...
                                <div class="blog-card__image__layer"
                                    style="background-image: url(assets/images/blog/blog-1-2.png);"></div>
                                <a href="blog-details-right.html" class="blog-card__image__link"><span
                                        class="sr-only">That jerk from finance really threw me</span>
                                    <!-- /.sr-only --></a>
                            </div><!-- /.blog-card__image -->
                            <div class="blog-card__content">
                                <div class="blog-card__content__top">
                                    <a href="blog-list.html" class="blog-card__category">Painting</a>
                                    <div class="blog-card__date">30 Mar, 2023</div><!-- /.blog-card__date -->
                                </div><!-- /.blog-card__content__top -->
                                <h3 class="blog-card__title"><a href="blog-details-right.html">That jerk from finance
                                        really threw me</a></h3><!-- /.blog-card__title -->
                                <div class="blog-card__content__bottom">
                                    <div class="blog-card__author">
                                        <div class="blog-card__author__image">
                                            <img src="assets/images/blog/blog-author-1-1.jpg" alt="Wade Warren">
                        ...
                        <div class="blog-card wow fadeInUp" data-wow-duration='1500ms' data-wow-delay='200ms'
                            ...
                            <div class="blog-card__image">
                                ...
                                <div class="blog-card__image__layer"
                                    style="background-image: url(assets/images/blog/blog-1-3.png);"></div>
                                <a href="blog-details-right.html" class="blog-card__image__link"><span
                                        class="sr-only">Form without content style without</span>
                                    <!-- /.sr-only --></a>
                            </div><!-- /.blog-card__image -->
                            <div class="blog-card__content">
                                <div class="blog-card__content__top">
                                    <a href="blog-list.html" class="blog-card__category">Gaming</a>
                                    <div class="blog-card__date">30 Mar, 2023</div><!-- /.blog-card__date -->
                                </div><!-- /.blog-card__content__top -->
                                <h3 class="blog-card__title"><a href="blog-details-right.html">Form without content
                                        style without</a></h3><!-- /.blog-card__title -->
                                <div class="blog-card__content__bottom">
                                    <div class="blog-card__author">
                                        <div class="blog-card__author__image">
                                            <img src="assets/images/blog/blog-author-1-1.jpg" alt="Wade Warren">
