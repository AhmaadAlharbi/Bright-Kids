(function () {
    ...
    var options = {
        ...
        colors: ["#0162e8", "#00b9ff", "#fbbc0b", "#49b6f5", "#ee335e"],
    ...
    var options = {
        ...
        colors: ["#0162e8", "#00b9ff", "#fbbc0b", "#ee335e", "#49b6f5"],
        legend: {
            position: 'bottom',
        }
    };
    var chart12 = new ApexCharts(document.querySelector("#donut-update"), options);
    chart12.render();
    function appendData() {
        var arr = chart12.w.globals.series.slice()
    ...
    function randomize() {
        return chart12.w.globals.series.map(function () {
    ...
    document.querySelector("#randomize").addEventListener("click", function () {
        chart12.updateSeries(randomize())
    })
    document.querySelector("#add").addEventListener("click", function () {
        chart12.updateSeries(appendData())
    })
    document.querySelector("#remove").addEventListener("click", function () {
        chart12.updateSeries(removeData())
    })
    document.querySelector("#reset").addEventListener("click", function () {
        chart12.updateSeries(reset())
    })
