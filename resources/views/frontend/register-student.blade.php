...
<head>
    ...
    <title>
        Checkout page || Kidearn || HTML Template For Kindergarten & Baby Care
    </title>
    <!-- favicons Icons -->
    ...
    <div class="page-wrapper">
                        ...
                        <ul class="main-menu__list">
                                                    ...
                                                    <div class="container">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-6 col-lg-4">
                                                                <div class="demo-one__card">
                                                                    <div class="demo-one__image">
                                                                        <img src="assets/images/landing/home-4.jpg"
                                                                            alt="kidearn" />
                                                                        <div class="demo-one__btns">
                                                                            <a href="index-4.html"
                                                                                class="kidearn-btn demo-one__btn">
                            ...
                            <li class="dropdown">
                                ...
                                <ul>
                                    ...
                                    <li>
                                        <a href="programs-d-kindergarten.html">Kindergarten program</a>
                                    </li>
                                    <li>
                                    ...
                                    <li>
                                        <a href="programs-d-discipline.html">Discipline program</a>
                                    </li>
                                </ul>
                            </li>
                    ...
                    <div class="main-header__right">
                        ...
                        <a class="main-header__call" href="tel:303555-0105">
                            ...
                            <span class="main-header__call__content">
                                ...
                                <!-- /.main-header__call__text --> </span><!-- /.main-header__call__content -->
                        </a>
                        <a href="contact.html" class="kidearn-btn main-header__btn">
                            <span>Book a Visit</span> </a><!-- /.thm-btn main-header__btn -->
                    </div>
                    <!-- /.main-header__right -->
                </div>
                <!-- /.main-header__inner -->
        ...
        <section class="checkout-page">
            <div class="container">
                ...
                @endif
                <form action="{{ route('register-new-student.store') }}" method="POST" enctype="multipart/form-data"
                    ...
                    <div class="row bs-gutter-x-20">
                        <div class="col-xl-6">
                            <div class="checkout-page__input-box">
                                <input type="text" name="father_first_name" value="{{ old('father_first_name') }}"
                        ...
                        <div class="col-xl-6">
                            <div class="checkout-page__input-box">
                                <input type="text" name="father_last_name" value="{{ old('father_last_name') }}"
                        ...
                        <div class="col-xl-6">
                            <div class="checkout-page__input-box">
                                <input type="tel" name="father_phone" value="{{ old('father_phone') }}"
                                    placeholder="Father's Phone" required>
                                @error('father_phone')
                                <span class="text-danger">{{ $message }}</span>
                                @enderror
                            </div>
                        ...
                        <div class="col-xl-6">
                            <div class="checkout-page__input-box">
                                <input type="email" name="father_email" value="{{ old('father_email') }}"
                                    placeholder="Father's Email" required>
                                @error('father_email')
                                <span class="text-danger">{{ $message }}</span>
                                @enderror
                            </div>
                    ...
                    <div class="row bs-gutter-x-20">
                        <div class="col-xl-6">
                            <div class="checkout-page__input-box">
                                <input type="text" name="mother_first_name" value="{{ old('mother_first_name') }}"
                        ...
                        <div class="col-xl-6">
                            <div class="checkout-page__input-box">
                                <input type="tel" name="mother_phone" value="{{ old('mother_phone') }}"
                                    placeholder="Mother's Phone" required>
                                @error('mother_phone')
                                <span class="text-danger">{{ $message }}</span>
                                @enderror
                            </div>
                        ...
                        <div class="col-xl-6">
                            <div class="checkout-page__input-box">
                                <input type="email" name="mother_email" value="{{ old('mother_email') }}"
                                    placeholder="Mother's Email" required>
                                @error('mother_email')
                                <span class="text-danger">{{ $message }}</span>
                                @enderror
                            </div>
                    ...
                    <div class="row bs-gutter-x-20">
                        <div class="col-xl-6">
                            <div class="checkout-page__input-box">
                                <input type="text" name="grade" value="{{ old('grade') }}" placeholder="Grade" required>
                                @error('grade')
                                <span class="text-danger">{{ $message }}</span>
                                @enderror
                            </div>
                        ...
                        <div class="col-xl-12">
                            <div class="checkout-page__input-box">
                                <textarea name="address"
                                    placeholder="Student's Address (if different from parents)">{{ old('address') }}</textarea>
                                @error('address')
                                <span class="text-danger">{{ $message }}</span>
                                @enderror
                            </div>
                        ...
                        <div class="col-xl-12">
                            <div class="checkout-page__input-box">
                                <textarea name="medical_info"
                                    placeholder="Medical Information">{{ old('medical_info') }}</textarea>
                                @error('medical_info')
                                <span class="text-danger">{{ $message }}</span>
                                @enderror
                            </div>
                    ...
                    <div class="row">
                        <div class="col-xl-12">
                            <div class="checkout-page__input-box">
                                <textarea name="notes" placeholder="Additional Notes">{{ old('notes') }}</textarea>
                                @error('notes')
                                <span class="text-danger">{{ $message }}</span>
                                @enderror
                            </div>
                ...
                <div class="container">
                    <div class="main-footer__bottom__inner">
                        <p class="main-footer__copyright">
                            &copy; Copyright <span class="dynamic-year"></span> by Kidearn
                            HTML Template.
                        </p>
                    </div>
                    <!-- /.main-footer__inner -->
