						...
						<div class="header-content-right">
							...
							<div class="header-element messages-dropdown">
								...
								<div class="main-header-dropdown dropdown-menu dropdown-menu-end main-header-message" data-popper-placement="none">
									...
									<ul class="list-unstyled mb-0" id="header-cart-items-scroll">
										<li class="dropdown-item">
											<div class="d-flex messages">
												...
												<div>
													<div class="d-flex">
														<a href="javascript:void(0);"><h6 class="mb-1 name">Petey Cruiser</h6></a>
													</div>
										...
										<li class="dropdown-item">
											<div class="d-flex messages">
												...
												<div>
													<div class="d-flex">
														<a href="javascript:void(0);"><h6 class="mb-1 name">Jimmy Changa</h6></a>
													</div>
										...
										<li class="dropdown-item">
											<div class="d-flex messages">
												...
												<div>
													<div class="d-flex">
														<a href="javascript:void(0);"><h6 class="mb-1 name">Graham Cracker</h6></a>
													</div>
										...
										<li class="dropdown-item">
											<div class="d-flex messages">
												...
												<div>
													<div class="d-flex">
														<a href="javascript:void(0);"><h6 class="mb-1 name">Donatella Nobatti</h6></a>
													</div>
										...
										<li class="dropdown-item">
											<div class="d-flex messages">
												...
												<div>
													<div class="d-flex">
														<a href="javascript:void(0);"><h6 class="mb-1 name">Anne Fibbiyon</h6></a>
													</div>
									...
									<div class="text-center dropdown-footer">
										<a href="javascript:void(0);" class="text-primary fs-13">VIEW ALL</a>
									</div>
								</div>
									...
									<ul class="list-unstyled mb-0" id="header-notification-scroll">
										<li class="dropdown-item px-3">
											<div class="d-flex">
												...
												<div class="ms-3">
													<a href="javascript:void(0);"><h5 class="notification-label text-dark mb-1">New files available</h5></a>
													<div class="notification-subtext">10 hour ago</div>
												</div>
												<div class="ms-auto" >
													<a href="javascript:void(0);"><i class="las la-angle-right text-end text-muted icon"></i></a>
												</div>
											</div>
										</li>
										<li class="dropdown-item px-3">
											<div class="d-flex">
												...
												<div class="ms-3">
													<a href="javascript:void(0);"><h5 class="notification-label text-dark mb-1">Updates Available</h5></a>
										...
										<li class="dropdown-item px-3">
											<div class="d-flex">
												...
												<div class="ms-3">
													<a href="javascript:void(0);"><h5 class="notification-label text-dark mb-1">New Order Received</h5></a>
										...
										<li class="dropdown-item px-3">
											<div class="d-flex">
												...
												<div class="ms-3">
													<a href="javascript:void(0);"><h5 class="notification-label text-dark mb-1">New review received</h5></a>
										...
										<li class="dropdown-item px-3">
											<div class="d-flex">
												...
												<div class="ms-3">
													<a href="javascript:void(0);"><h5 class="notification-label text-dark mb-1">22 verified registrations</h5></a>
										...
										<li class="dropdown-item px-3">
											<div class="d-flex">
												...
												<div class="ms-3">
													<a href="javascript:void(0);"><h5 class="notification-label text-dark mb-1">Project has been approved</h5></a>
							...
							<div class="header-element headerProfile-dropdown">
								...
								<ul class="main-header-dropdown dropdown-menu pt-0 header-profile-dropdown dropdown-menu-end main-profile-menu" aria-labelledby="mainHeaderProfile">
									...
									<li><a class="dropdown-item d-flex" href="javascript:void(0);"><i class="bx bx-user-circle fs-18 me-2 op-7"></i>Profile</a></li>
									<li><a class="dropdown-item d-flex" href="javascript:void(0);"><i class="bx bx-cog fs-18 me-2 op-7"></i>Edit Profile </a></li>
									<li><a class="dropdown-item d-flex border-block-end" href="javascript:void(0);"><i class="bx bxs-inbox fs-18 me-2 op-7"></i>Inbox</a></li>
									<li><a class="dropdown-item d-flex" href="javascript:void(0);"><i class="bx bx-envelope fs-18 me-2 op-7"></i>Messages</a></li>
									<li><a class="dropdown-item d-flex border-block-end" href="javascript:void(0);"><i class="bx bx-slider-alt fs-18 me-2 op-7"></i>Account Settings</a></li>
									<li><a class="dropdown-item d-flex" href="javascript:void(0);"><i class="bx bx-log-out fs-18 me-2 op-7"></i>Sign Out</a></li>
								</ul>
							</div>  
							<!-- End::header-element -->
