...
<head>
    ...
    <title>Contact || Kidearn || HTML Template For Kindergarten & Baby Care</title>
    <!-- favicons Icons -->
    ...
    <div class="page-wrapper">
        ...
        <section class="contact-one">
            <div class="container">
                ...
                <form class="contact-one__form contact-form-validated form-one" action="{{route('contact.store')}}"
                    method="post">
                    @csrf
                    <div class="form-one__group">
                        ...
                        <div class="form-one__control form-one__control--full text-center">
                            <button type="submit" class="kidearn-btn kidearn-btn--xl"><span>Send a
                                    Message</span></button>
                        </div><!-- /.form-one__control -->
                    </div><!-- /.form-one__group -->
                </form>
