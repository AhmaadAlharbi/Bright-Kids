(function () {
    ...
    function formatState(state) {
        ...
        var baseUrl = "http://127.0.0.1:8000/build/assets/images/faces/select2";
        var $state = $(
    ...
    function selectClient(client) {
        ...
        var $client = $(
            '<span><img src="http://127.0.0.1:8000/build/assets/images/faces/select2/' + client.element.value.toLowerCase() + '.jpg" /> '
            + client.text + '</span>'
        );
        return $client;
    };
