(function () {
    ...
    var options = {
        ...
        colors: ["#0162e8", "#00b9ff", "#fbbc0b", "#ee335e", "#49b6f5", "#6d6ef3", "#5b67c7", "#a65e9a",
            "#22c03c", "#00b9ff"
        ],
        grid: {
            borderColor: '#f2f5f7',
    ...
    var options = {
        ...
        colors: ["#0162e8", "#00b9ff", "#fbbc0b", "#49b6f5"],
        title: {
    ...
    var options = {
        ...
        fill: {
            ...
            opacity: 0.87,
            image: {
                src: ['http://127.0.0.1:8000/build/assets/images/media/media-64.jpg'],
                width: 466,
                height: 406
            }
        },
